...
static const Rule rules[] = {
	...
	RULE(.class = "Sublime_text", .tags = 1 << 5)
	RULE(.class = "Pcmanfm", .tags = 1 << 3)
	RULE(.class = "mpv", .tags = 1 << 1)
	RULE(.class = "Brave-browser", .tags = 1 << 2)
	RULE(.class = "zoom", .tags = 1 << 8)
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_Print,		spawn,		  SHCMD("scrot-nodejs") },
	{ MODKEY|ControlMask,			XK_Print,		spawn,		  SHCMD("scrot-delay") },
